...
object Chapter0801 {
  ...
  def main(args: Array[String]) {
    ...
    .setAppName("Chapter 8")
    .set("spark.logConf", "true")
    val sc = new SparkContext(conf) // ("local","Chapter 8") if using directly
    println(s"Running Spark Version ${sc.version}")
    //
    val dataFile = sc.textFile("/Users/ksankar/bdtc-2014/car-data/car-milage-no-hdr.csv")
