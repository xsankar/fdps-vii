...
object Chapter0803 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //
    clusterMap.saveAsTextFile("/Users/ksankar/bdtc-2014/cluster-points/3x-cluster.csv")
    //
    ...
    clusterMap.saveAsTextFile("/Users/ksankar/bdtc-2014/cluster-points/5x-cluster.csv")
    clusterMap.foreach(println)
  }
}